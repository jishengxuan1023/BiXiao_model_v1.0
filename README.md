...
**The BeXiaoCastNet3D.ts and BiXiaoCastNet3DENV.ts should be downloaded firstly from Zenodo ([![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17591610.svg)](https://doi.org/10.5281/zenodo.17591610)) to the working folder.**
